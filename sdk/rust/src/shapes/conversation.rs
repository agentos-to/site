...
pub static CONVERSATION: Lazy<ShapeDef> = Lazy::new(|| ShapeDef {
    ...
    fields: vec![
        ...
        FieldDef { name: "costSource".into(), ty: FieldType::String, description: Some("where costUsd came from — provider-reported, graph-computed from list price, or unknown".into()), required: false, enum_values: vec!["reported".into(), "computed".into(), "unpriced".into()] },
        ...
        FieldDef::optional("iterations", FieldType::Integer),
        ...
        FieldDef { name: "status".into(), ty: FieldType::String, description: Some("how an agent run ended — completed, errored, or hit its iteration cap".into()), required: false, enum_values: vec!["done".into(), "error".into(), "timeout".into()] },
