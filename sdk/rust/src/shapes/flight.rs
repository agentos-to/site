// DO NOT EDIT — generated from platform/ontology/shapes/flight.yaml.
...
pub static FLIGHT: Lazy<ShapeDef> = Lazy::new(|| ShapeDef {
    name: "flight".into(),
    plural: Some("flights".into()),
    description: Some("A flight — a specific leg of air travel. A flight IS a leg.".into()),
    fields: vec![
