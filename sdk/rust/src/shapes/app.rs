...
pub static APP: Lazy<ShapeDef> = Lazy::new(|| ShapeDef {
    ...
    description: Some("An app — the launchable program a person opens: a system app (Finder,".into()),
    fields: vec![
