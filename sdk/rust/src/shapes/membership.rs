// DO NOT EDIT — generated from platform/ontology/shapes/membership.yaml.
...
pub static MEMBERSHIP: Lazy<ShapeDef> = Lazy::new(|| ShapeDef {
    name: "membership".into(),
    plural: Some("memberships".into()),
    description: Some("A time-bounded right-of-belonging granted by an organization.".into()),
    fields: vec![
