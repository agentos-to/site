...
pub static PERSON: Lazy<ShapeDef> = Lazy::new(|| ShapeDef {
    ...
    shortcuts: vec![
        ShortcutDef { key: "additionalName".into(), writes: "born_in[is=birth].additionalName".into(), inverse: None },
        ShortcutDef { key: "birthdate".into(), writes: "born_in[is=birth].startDate".into(), inverse: Some("birth_of".into()) },
        ShortcutDef { key: "familyName".into(), writes: "born_in[is=birth].familyName".into(), inverse: None },
        ShortcutDef { key: "gender".into(), writes: "born_in[is=birth].gender".into(), inverse: None },
        ShortcutDef { key: "givenName".into(), writes: "born_in[is=birth].givenName".into(), inverse: None },
        ShortcutDef { key: "honorificPrefix".into(), writes: "born_in[is=birth].honorificPrefix".into(), inverse: None },
        ShortcutDef { key: "honorificSuffix".into(), writes: "born_in[is=birth].honorificSuffix".into(), inverse: None },
        ShortcutDef { key: "legalName".into(), writes: "born_in[is=birth].legalName".into(), inverse: None },
        ShortcutDef { key: "maidenName".into(), writes: "born_in[is=birth].maidenName".into(), inverse: None },
        ShortcutDef { key: "nameOrder".into(), writes: "born_in[is=birth].nameOrder".into(), inverse: None },
        ShortcutDef { key: "nickname".into(), writes: "born_in[is=birth].nickname".into(), inverse: None },
        ShortcutDef { key: "phoneticFamilyName".into(), writes: "born_in[is=birth].phoneticFamilyName".into(), inverse: None },
        ShortcutDef { key: "phoneticGivenName".into(), writes: "born_in[is=birth].phoneticGivenName".into(), inverse: None },
        ShortcutDef { key: "sortAs".into(), writes: "born_in[is=birth].sortAs".into(), inverse: None },
    ],
