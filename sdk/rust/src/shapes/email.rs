...
pub static EMAIL: Lazy<ShapeDef> = Lazy::new(|| ShapeDef {
    ...
    fields: vec![
        ...
        FieldDef::optional("isDraft", FieldType::Boolean),
        FieldDef::optional("isInbox", FieldType::Boolean),
        FieldDef::optional("isOutgoing", FieldType::Boolean),
        FieldDef::optional("isSent", FieldType::Boolean),
        FieldDef::optional("isSpam", FieldType::Boolean),
        FieldDef::optional("isStarred", FieldType::Boolean),
        FieldDef::optional("isTrash", FieldType::Boolean),
