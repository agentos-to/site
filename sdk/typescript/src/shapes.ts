...
export const SHAPE_DISPLAY: Record<string, Display> = {
    ...
    "airline": {"subtitle": "iataCode", "also": ["organization", "actor"]},
    "airport": {"subtitle": "iataCode", "also": []},
    "app": {"subtitle": "name", "also": []},
    "book": {"subtitle": "written_by", "also": ["creative_work", "product"]},
    ...
    "font": {"subtitle": "author", "also": ["creative_work"]},
    ...
    "health-immunization": {"subtitle": "dateAdministered", "also": ["event"]},
    "health-lab": {"subtitle": "labType", "also": ["organization", "actor"]},
    "health-observation": {"subtitle": "effectiveDate", "also": ["result"]},
    "health-panel": {"subtitle": "effectiveDate", "also": ["list"]},
    "health-procedure": {"subtitle": "performedDate", "also": ["event"]},
    "health-reference-range": {"subtitle": "refText", "also": []},
    "icon": {"subtitle": "purpose", "also": ["creative_work"]},
    "image": {"subtitle": "format", "also": ["creative_work", "file"]},
    ...
    "meeting": {"subtitle": "location", "also": ["event"]},
    ...
    "organization": {"subtitle": "industry", "also": ["actor"]},
    "pass": {"subtitle": "status", "also": []},
    "payment_method": {"subtitle": "displayName", "also": []},
    "person": {"subtitle": "about", "also": ["actor"]},
    ...
    "sound": {"subtitle": "purpose", "also": ["creative_work", "file"]},
    ...
    "video": {"subtitle": "author", "also": ["creative_work", "file"]},
