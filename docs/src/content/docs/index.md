...
- **[Introduction](/docs/introduction/what-is-agentos/)** — [what AgentOS is](/docs/introduction/what-is-agentos/), [the vision](/docs/introduction/vision/), and [who it's for](/docs/introduction/two-users/).
...
- **[Architecture](/docs/architecture/overview/)** — [how AgentOS is built](/docs/architecture/overview/), [security by architecture](/docs/architecture/security/), [local-first](/docs/architecture/local-first/), and the [data model](/docs/architecture/data-model/).
