...
**Category:** `finance` · **Capabilities:** `sql` · **Website:** https://copilot.money

## Returns shapes

- [`account[]`](/docs/reference/shapes/account/) — from `load_accounts`
- [`transaction[]`](/docs/reference/shapes/transaction/) — from `fetch_transactions`
