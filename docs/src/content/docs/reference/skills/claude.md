...
**Category:** `ai` · **Capabilities:** `http`, `secrets`, `shell` · **Website:** https://claude.ai

## Returns shapes

- [`conversation`](/docs/reference/shapes/conversation/) — from `get_conversation`, `read_conversation_cli`
- [`conversation[]`](/docs/reference/shapes/conversation/) — from `list_conversations`, `search_conversations`, `list_conversations_cli`
- [`message[]`](/docs/reference/shapes/message/) — from `import_conversation`
- [`model[]`](/docs/reference/shapes/model/) — from `list_models`, `list_models_cli`
