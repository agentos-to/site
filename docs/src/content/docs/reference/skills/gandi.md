...
**Category:** `hosting` · **Capabilities:** `http` · **Website:** https://www.gandi.net

## Returns shapes

- [`dns_record`](/docs/reference/shapes/dns_record/) — from `get_dns_record`
- [`dns_record[]`](/docs/reference/shapes/dns_record/) — from `list_dns_records`
- [`domain`](/docs/reference/shapes/domain/) — from `get_domain`
- [`domain[]`](/docs/reference/shapes/domain/) — from `list_domains`
