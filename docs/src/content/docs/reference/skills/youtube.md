...
**Category:** `media` · **Capabilities:** `http` · **Website:** https://youtube.com

## Returns shapes

- [`channel`](/docs/reference/shapes/channel/) — from `get_channel`, `get_avatar_channel`
- [`post[]`](/docs/reference/shapes/post/) — from `list_posts`
- [`video`](/docs/reference/shapes/video/) — from `get_video`, `transcript_video`
- [`video[]`](/docs/reference/shapes/video/) — from `search_videos`, `search_recent_video`, `list_videos`
