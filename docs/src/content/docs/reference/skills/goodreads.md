...
**Category:** `media` · **Capabilities:** `http` · **Website:** https://goodreads.com

## Returns shapes

- [`account`](/docs/reference/shapes/account/) — from `get_profile`
- [`book`](/docs/reference/shapes/book/) — from `get_book`
- [`book[]`](/docs/reference/shapes/book/) — from `list_similar_books`, `list_series_books`, `search_books`, `list_author_books`, `list_books`, `list_shelf_books`
- [`group[]`](/docs/reference/shapes/group/) — from `list_groups`
- [`person`](/docs/reference/shapes/person/) — from `get_author`, `get_person`
- [`person[]`](/docs/reference/shapes/person/) — from `search_people`, `list_friends`, `resolve_email`, `list_following`, `list_followers`
- [`quote[]`](/docs/reference/shapes/quote/) — from `list_quotes`
- [`review[]`](/docs/reference/shapes/review/) — from `list_book_reviews`, `list_reviews`
- [`shelf[]`](/docs/reference/shapes/shelf/) — from `list_shelves`
- `void` — from `public_authenticate`

## Connections

- **`graphql`** — Public AppSync GraphQL — API key auto-discovered from JS bundles
- **`web`** — Goodreads user cookies for viewer-scoped data (friends, shelves, books, reviews)
