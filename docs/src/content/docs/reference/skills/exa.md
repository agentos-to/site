...
**Category:** `web` · **Capabilities:** `http` · **Website:** https://exa.ai

## Returns shapes

- [`result[]`](/docs/reference/shapes/result/) — from `search`
- [`webpage`](/docs/reference/shapes/webpage/) — from `read_webpage`
