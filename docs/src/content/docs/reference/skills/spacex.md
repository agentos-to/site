...
**Category:** `fun` · **Capabilities:** `http` · **Website:** https://www.spacex.com

## Returns shapes

- [`event`](/docs/reference/shapes/event/) — from `get_launch`
- [`event[]`](/docs/reference/shapes/event/) — from `list_upcoming`, `list_past`
