...
**Category:** `logistics` · **Capabilities:** `http` · **Website:** https://www.amazon.com

## Returns shapes

- [`account`](/docs/reference/shapes/account/) — from `whoami`
- [`list`](/docs/reference/shapes/list/) — from `get_list`
- [`list[]`](/docs/reference/shapes/list/) — from `list_lists`
- [`order`](/docs/reference/shapes/order/) — from `get_order`
- [`order[]`](/docs/reference/shapes/order/) — from `list_orders`
- [`product`](/docs/reference/shapes/product/) — from `get_product`
- [`product[]`](/docs/reference/shapes/product/) — from `search_products`, `buy_again`
