...
**Category:** `comms` · **Capabilities:** `http`, `plist`, `secrets`, `sql` · **Website:** https://mimestream.com
...
- [`email`](/docs/reference/shapes/email/) — from `get_email`
- [`email[]`](/docs/reference/shapes/email/) — from `list_emails`, `search_emails`
