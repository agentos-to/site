...
**Category:** `dev` · **Capabilities:** `http` · **Website:** https://greptile.com

## Returns shapes

- [`account[]`](/docs/reference/shapes/account/) — from `list_members`
- [`invitation`](/docs/reference/shapes/invitation/) — from `send_invite`
- [`invitation[]`](/docs/reference/shapes/invitation/) — from `list_invites`
