...
**Category:** `productivity` · **Capabilities:** `http` · **Website:** https://granola.ai
...
- [`meeting`](/docs/reference/shapes/meeting/) — from `op_get_meeting`
- [`meeting[]`](/docs/reference/shapes/meeting/) — from `op_list_meetings`
