...
**Category:** `logistics` · **Capabilities:** `http` · **Website:** https://uber.com

## Returns shapes

- [`order`](/docs/reference/shapes/order/) — from `get_delivery`, `get_messages`, `add_to_cart`, `checkout`, `track_delivery`
- [`order[]`](/docs/reference/shapes/order/) — from `list_deliveries`, `get_cart`
- [`place`](/docs/reference/shapes/place/) — from `get_store`
- [`place[]`](/docs/reference/shapes/place/) — from `search_address`, `list_addresses`, `search_stores`, `list_nearby_stores`
- [`product`](/docs/reference/shapes/product/) — from `get_item_customizations`
- [`product[]`](/docs/reference/shapes/product/) — from `search_products`
- [`trip`](/docs/reference/shapes/trip/) — from `get_trip`
- [`trip[]`](/docs/reference/shapes/trip/) — from `list_trips`
