...
**Category:** `web` · **Capabilities:** `http` · **Website:** https://posthog.com

## Returns shapes

- [`event`](/docs/reference/shapes/event/) — from `get_event`
- [`event[]`](/docs/reference/shapes/event/) — from `list_events`
- [`person`](/docs/reference/shapes/person/) — from `get_person`
- [`person[]`](/docs/reference/shapes/person/) — from `list_persons`, `search_persons`
