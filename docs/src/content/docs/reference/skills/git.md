...
**Category:** `dev` · **Capabilities:** `shell` · **Website:** https://git-scm.com

## Returns shapes

- [`branch`](/docs/reference/shapes/branch/) — from `get_branch`
- [`branch[]`](/docs/reference/shapes/branch/) — from `list_branches`
- [`git_commit`](/docs/reference/shapes/git_commit/) — from `get_git_commit`
- [`git_commit[]`](/docs/reference/shapes/git_commit/) — from `list_git_commits`, `search_git_commits`
- [`repository`](/docs/reference/shapes/repository/) — from `get_repository`
- [`tag`](/docs/reference/shapes/tag/) — from `get_tag`
- [`tag[]`](/docs/reference/shapes/tag/) — from `list_tags`
