...
**Category:** `productivity` · **Capabilities:** `http` · **Website:** https://todoist.com

## Returns shapes

- [`project[]`](/docs/reference/shapes/project/) — from `list_projects`
- [`tag[]`](/docs/reference/shapes/tag/) — from `list_tags`
- [`task`](/docs/reference/shapes/task/) — from `get_task`, `create_task`, `update_task`, `move_task`
- [`task[]`](/docs/reference/shapes/task/) — from `list_tasks`, `list_all_tasks`, `filter_task`
