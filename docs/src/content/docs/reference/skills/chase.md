...
**Category:** `finance` · **Capabilities:** `http` · **Website:** https://www.chase.com

## Returns shapes

- [`account`](/docs/reference/shapes/account/) — from `check_session`
- [`account[]`](/docs/reference/shapes/account/) — from `get_accounts`
- [`transaction[]`](/docs/reference/shapes/transaction/) — from `get_transactions`
