---
title: Gmail
description: "Full-featured Gmail — read, search, send, reply, forward, label, archive, draft, attachments, filters, and batch operations. Auth can use the shared `google`..."
sidebar:
  label: gmail
---

**Category:** `comms` · **Capabilities:** `http` · **Website:** https://mail.google.com

## Returns shapes

- [`conversation`](/docs/reference/shapes/conversation/) — from `get_conversation`
- [`conversation[]`](/docs/reference/shapes/conversation/) — from `list_conversations`
- [`email`](/docs/reference/shapes/email/) — from `get_email`, `get_draft`, `send_email`, `reply_email`, `forward_email`, `modify_email`, `trash_email`, `untrash_email`, `create_draft`, `update_draft`, `send_draft`
- [`email[]`](/docs/reference/shapes/email/) — from `list_email_stubs`, `list_emails`, `search_emails`, `list_drafts`
- [`file`](/docs/reference/shapes/file/) — from `get_attachment`
- [`tag`](/docs/reference/shapes/tag/) — from `create_label`, `update_label`
- [`tag[]`](/docs/reference/shapes/tag/) — from `list_labels`
