...
**Category:** `dev` · **Capabilities:** `http`, `shell`, `sql` · **Website:** https://cursor.com

## Returns shapes

- [`file[]`](/docs/reference/shapes/file/) — from `op_pull_document`
- [`session`](/docs/reference/shapes/session/) — from `op_get_session`
- [`session[]`](/docs/reference/shapes/session/) — from `op_list_sessions`, `op_backfill_session`
