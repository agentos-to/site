...
**Category:** `hosting` · **Capabilities:** `http` · **Website:** https://here.now

## Returns shapes

- [`website`](/docs/reference/shapes/website/) — from `op_create_website`, `op_update_website`
- [`website[]`](/docs/reference/shapes/website/) — from `list_websites`
