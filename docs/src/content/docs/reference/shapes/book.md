...
| Relation | Target |
|---|---|
| `writtenBy` | [`person`](/docs/reference/shapes/person/) |
| `contributors` | [`person[]`](/docs/reference/shapes/person/) |
| `publisher` | [`organization`](/docs/reference/shapes/organization/) |
