...
description: "WorkOS is a B2B auth platform used by many SaaS and desktop apps. It started as an enterprise SSO product (SAML, SCIM) but added WorkOS User Management in…"
...
Part of [Layer 3: Auth & Runtime](./index.md). See also
