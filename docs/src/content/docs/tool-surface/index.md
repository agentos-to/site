...
- [`apps`](/tool-surface/apps/) (6 ops) — App introspection and direct dispatch
...
- [`services`](/tool-surface/services/) *(empty)* — Brokered interfaces — ask for a service, the engine picks the app
