...
| Relation | Target |
|---|---|
| `on` | [`product`](/shapes/reference/product/) |
| `invoked_by` | [`actor`](/shapes/reference/actor/) |
| `in` | [`message`](/shapes/reference/message/) |
| `replies_to` | [`tool_call`](/shapes/reference/tool_call/) |
