...
- **[W3C RDF 1.1 + Named Graphs](https://www.w3.org/TR/rdf11-concepts/)** — Formal underpinning. Our nodeCount/linkCount mirror RDF subject-predicate-object triples; snapshots ≈ named-graph versioning.
