...
- [`health-lab`](/shapes/reference/health-lab/)

## Prior art

External standards this shape draws from or aligns with. See [Shape design principles](/shapes/shape-design-principles/) for how prior art informs shape design.

- **[schema.org/Organization](https://schema.org/Organization)** — Our industry ≈ naics/isicV4 (loosely); founded = foundingDate; member[] = member; headquarters = location; parentOrganization maps directly (schema.org's subOrganization is its declared inverse).
