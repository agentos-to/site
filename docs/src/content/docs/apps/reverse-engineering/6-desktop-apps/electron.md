---
title: "Electron App Deep Dive"
description: "Electron apps are Chromium + Node.js packaged into a desktop shell — readable JS bundles, standard Chromium storage, and auth tokens often sitting in a JSON file."
---
...
Part of [Layer 6: Desktop Apps](./overview.mdx). See also [3-auth](../3-auth/overview.mdx) for
...
See the `apps/browsers/brave-browser/` app for the full
