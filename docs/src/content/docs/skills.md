...
Shapes define the structure of entities. See **[shapes.md](shapes.md)** for the full reference (design principles, the `also` inheritance chain, `_tag` polymorphism, identity rules).
