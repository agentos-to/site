---
title: "Reverse Engineering — macOS Desktop & Electron Apps"
description: "When the target is a desktop app (Slack, Notion, Granola, VS Code) that stores data locally and syncs with a backend — the API is often undocumented, but the app itself is your best source."
---
...
**Sub-page:** [Electron deep dive](./electron.md) — asar extraction, token files, CrossAppAuth, feature flags.
...
If you get `403`, try `httpx` with HTTP/2 (see [1-transport](../1-transport.md)).
