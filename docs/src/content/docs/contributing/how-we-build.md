...
Start at the [Skills overview](/docs/contributing/skills/overview/).
...
See [Apps overview](/docs/contributing/apps/overview/).

## Proposals & roadmap

Design thinking lives in `_roadmap/` — pain, proposal, review, closeout. The pipeline is described in [Roadmap & proposals](/docs/contributing/roadmap-and-proposals/).
