...
Shapes define the structure of entities. See the [Ontology overview](/shapes/overview/) for the full reference (design principles, the `also` inheritance chain, `_tag` polymorphism, identity rules).
