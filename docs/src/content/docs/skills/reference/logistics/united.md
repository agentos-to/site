...
- [`account`](/shapes/reference/account/) — from `store_session_cookies`, `check_session`
- [`booking_offer`](/shapes/reference/booking_offer/) — from `prepare_booking`
- [`membership`](/shapes/reference/membership/) — from `get_mileageplus`
- [`offer[]`](/shapes/reference/offer/) — from `search_flights`
- [`pass[]`](/shapes/reference/pass/) — from `register_seats`
- [`person`](/shapes/reference/person/) — from `get_profile`
- [`reservation`](/shapes/reference/reservation/) — from `get_cart`, `select_flight`, `register_traveler`
- [`reservation[]`](/shapes/reference/reservation/) — from `list_trips`
- [`seatmap`](/shapes/reference/seatmap/) — from `get_seatmap`
