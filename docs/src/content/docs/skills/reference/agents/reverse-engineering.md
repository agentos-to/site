...
description: "Systematically analyze and document how software systems work internally. Use when you need to understand closed-source systems, third-party integrations, or..."
sidebar:
