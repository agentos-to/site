...
| **Also** | [`document`](/docs/reference/shapes/document/) |
...
| Relation | Target |
|---|---|
| `commissionedBy` | [`actor`](/docs/reference/shapes/actor/) |
| `relatedSpecs` | [`spec[]`](/docs/reference/shapes/spec/) |

## Inherited

From [`document`](/docs/reference/shapes/document/):
