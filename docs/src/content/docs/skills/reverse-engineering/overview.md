...
description: "How to build skills against web services that don't have public APIs — extracting data surfaces, auth flows, and content, then packaging them as reliable AgentOS skills."
---
