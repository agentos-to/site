...
<CardGrid>
  <LinkCard title="Electron deep dive" href="/skills/reverse-engineering/6-desktop-apps/electron/" description="asar extraction, token files, CrossAppAuth, feature flags." />
</CardGrid>
