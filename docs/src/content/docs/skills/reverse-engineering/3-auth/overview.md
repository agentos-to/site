---
title: "Reverse Engineering — Auth & Credentials"
description: "How to log into things, get API keys, and store credentials — for any web service."
---
...
- [NextAuth.js / Auth.js](./nextauth.md)
- [WorkOS](./workos.md)
...
[Discovery: JS Bundle Scanning](../2-discovery.md#js-bundle-scanning) and
[Discovery: Navigation API Interception](../2-discovery.md#navigation-api-interception).
...
| Custom OTP/code verification | Scan JS bundles for custom endpoints → `agentos.http` replay (see [discovery](../2-discovery.md#js-bundle-scanning)) |
...
| Unknown client-side token construction | Navigation API interceptor → read the actual URL (see [discovery](../2-discovery.md#navigation-api-interception)) |
...
Some cookies should be **excluded** (see [1-transport](../1-transport.md)
