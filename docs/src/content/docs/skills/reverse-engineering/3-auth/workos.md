---
title: "WorkOS Auth Pattern"
description: "WorkOS is a B2B auth platform used by many SaaS and desktop apps, covering enterprise SSO (SAML, SCIM) plus consumer sign-up and social login via WorkOS User Management."
---
...
Part of [Layer 3: Auth & Runtime](./overview.mdx). See also
