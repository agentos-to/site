...
This is what makes the engine generic. Adding a new entity type is a YAML file in `site/docs/shapes/`, not a Rust change. See the [Ontology overview](/docs/ontology/overview/) for the full shape system.
...
- [Ontology overview](/docs/ontology/overview/) — the full shape system and the tactical reference.
- [Identity & change](/docs/ontology/identity-and-change/) — why every actor and every change is an entity too.
