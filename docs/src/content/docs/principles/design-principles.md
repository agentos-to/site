...
See [Shape design principles](/docs/ontology/shape-design-principles/) for how this shapes the ontology — in particular *#2 no counts on shapes*.
...
See [Identity & change](/docs/ontology/identity-and-change/).
...
- [Shape design principles](/docs/ontology/shape-design-principles/) — how these apply at the ontology level.
