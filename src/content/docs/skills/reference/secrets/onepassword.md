---
title: 1Password
description: "Credential provider backed by the 1Password CLI (`op`). Exposes Login and API-Credential vault items via `@provides(login_credentials)` and `@provides(api_ke..."
sidebar:
  label: onepassword
---
