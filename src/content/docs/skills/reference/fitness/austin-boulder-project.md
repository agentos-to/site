...
- [`class[]`](/shapes/reference/class/) — from `get_schedule`
- [`membership[]`](/shapes/reference/membership/) — from `get_my_memberships`
- [`pass[]`](/shapes/reference/pass/) — from `get_my_passes`
- [`place[]`](/shapes/reference/place/) — from `get_locations`
